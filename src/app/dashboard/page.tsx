...
const Dashboard = () => {
    ...
    return (
        <div className="py-20 h-screen justify-center">
            ...
            <div className="flex flex-wrap h-screen sm:grid sm:grid-cols-4 sm:grid-rows-10 gap-99 content-center m-8">
                ...
                <Card className="col-start-1 col-end-3 row-start-1 row-end-9 m-2">
                    <CardHeader>
                        <CardTitle
